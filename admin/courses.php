<h1 class="text-start my-3 screen-name">Add New Course</h1>
<div class="card rounded shadow border-0 p-5 text-start">
    <form id="myForm" method="post">
        <div class="row pb-3">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <label class="form-label ">Name</label>
                <input class="form-control" placeholder="1A" />
            </div>

            <div class="col-lg-6 col-md-6 col-sm-12">
                <label class="form-label">Intrest</label>
                <div class="input-group">
                    <input class="form-control" placeholder="100" aria-label="Amount (to the nearest dollar)" />
                </div>
            </div>
        </div>
        ...
        <div class="row pb-3">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <input class="form-control" placeholder="The full Marks" />
            </div>

            <div class="col-lg-6 col-md-6 col-sm-12">
                <label class="form-label ">Period</label>
                <input class="form-control" placeholder="Number of months" />
            </div>
        </div>
